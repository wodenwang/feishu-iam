...
```bash
docker buildx build --platform linux/amd64,linux/arm64 --provenance=false --sbom=false -f deploy/api.Dockerfile -t dockerhub.it.tangtring.com:80/ai/feishu-iam:v0.15.1 -t dockerhub.it.tangtring.com:80/ai/feishu-iam:latest --push .
```
